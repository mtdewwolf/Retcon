...
typedef FileRequest = Future<Map<String, dynamic>> Function(
  String method, {
...
class FakeFileService implements FileService {
  ...
  Future<FileWriteResult> write({
    ...
    int? limit,
      ...
      writeResult ?? FileWriteResult(path: path, size: content.length);
  ...
  Future<FileWatchHandle> watch({
    ...
    String? watchId,
      ...
      FileWatchHandle(watchId: watchId ?? 'watch-1', root: root);
